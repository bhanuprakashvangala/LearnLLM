...
const pricingPlans = [
  {
    name: "Free",
    description: "Start your AI journey - no coding needed",
    price: "$0",
    period: "forever",
    icon: Zap,
    features: [
      "ChatGPT mastery tutorials",
      "Prompt engineering basics",
      "Intro to AI concepts (plain English)",
      "No-code AI tools introduction",
  ...
  },
  {
    ...
    icon: Crown,
    features: [
      "All 50+ tutorials (beginner to advanced)",
      "Build real AI apps (no-code + code)",
      "RAG - AI with your documents",
      "Create chatbots & assistants",
